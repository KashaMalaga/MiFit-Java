...
public class I extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().a(this.mBackStackId, (int) STYLE_NO_TITLE);
                this.mBackStackId = -1;
                return;
            }
            aj a = getFragmentManager().a();
            a.a((Fragment) this);
            if (z) {
                a.i();
            } else {
    ...
    public int show(aj ajVar, String str) {
        ...
        ajVar.a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = ajVar.h();
        return this.mBackStackId;
    }

    public void show(R r, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        aj a = r.a();
