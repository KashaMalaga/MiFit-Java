...
final class C0236e implements Interpolator {
    private static final C0236e a = new C0236e();
    ...
    private static final float c = (1.0f / ((float) (b.length - 1)));

    private C0236e() {
    }

    public static final C0236e a() {
        return a;
    }
    ...
    public float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (b.length - 1)) * f), b.length - 2);
        float f2 = (f - (((float) min) * c)) / c;
        return ((b[min + 1] - b[min]) * f2) + b[min];
    }
}
