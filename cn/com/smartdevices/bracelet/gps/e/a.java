...
import com.xiaomi.hm.health.bt.a.C1114a;
...
public class a {
    ...
    public static void a(short s, short s2, byte b) {
        new C1114a(s, s2, b, null).g();
    }
    ...
    public static boolean g() {
        try {
            Method method = Class.forName("cn.com.smartdevices.bracelet.datasource.DeviceSource").getMethod("hasBind1S", new Class[0]);
            return method == null ? false : ((Boolean) method.invoke(null, new Object[0])).booleanValue();
        } catch (Exception e) {
            C0596r.a("BleDevice", e.getMessage());
            return false;
