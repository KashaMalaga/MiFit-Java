...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.k = e;
        this.l = d;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p.CircleImageView, i, d);
        this.l = obtainStyledAttributes.getDimensionPixelSize(p.CircleImageView_border_width, d);
        this.k = obtainStyledAttributes.getColor(p.CircleImageView_border_color, e);
