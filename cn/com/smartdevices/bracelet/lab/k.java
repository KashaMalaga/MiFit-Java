...
public final class k {
    ...
    public static SparseArray<ArrayList<a>> a(Context context) {
        ...
        if (!(DeviceSource.hasBindSensorHub() || f == null || f.a())) {
            ...
            aVar = new a(b);
            aVar.a = R.string.lab_factory_sport_type_ropeskipping;
            aVar.b = SportAnalyserActivity.class;
            arrayList.add(aVar);
            aVar = new a(a);
            aVar.a = R.string.lab_factory_sport_type_situp;
            aVar.b = SportAnalyserActivity.class;
            arrayList.add(aVar);
            if (h.e.ENABLE_SPORT_VOTE.booleanValue()) {
                aVar = new a(f);
                aVar.a = R.string.lab_factory_sport_more_sport_favorite_vote;
        ...
        if (cn.com.smartdevices.bracelet.gaocept.b.a) {
            try {
                aVar2 = new a(e);
                aVar2.a = R.string.lab_factory_internal_test;
            ...
            try {
                aVar2 = new a(d);
                aVar2.a = R.string.sport_running_helper_test;
        ...
        try {
            aVar2 = new a(g);
            aVar2.a = R.string.lab_step_test;
