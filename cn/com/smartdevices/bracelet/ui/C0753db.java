...
class C0753db implements e {
    ...
    public void b(WheelView wheelView) {
        ...
        if (100 == wheelView.f()) {
            ...
            if (this.a.isAdded()) {
                f c0763dl = new C0763dl(this.a.getActivity(), 1, this.a.g + 1, this.a.d, this.a.getResources().getColor(R.color.highlight), this.a.getResources().getColor(R.color.main_ui_content_color), a.bm, false, 46, 24, 21, 21, 1);
