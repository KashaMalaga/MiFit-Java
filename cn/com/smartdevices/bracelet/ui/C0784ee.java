...
public class C0784ee extends p implements OnClickListener, OnLongClickListener {
    ...
    private void a(View view) {
        this.C = (ScrollSlidingUpPanelLayout) view.findViewById(R.id.fragment_setting_sliding_layout);
        this.C.setOverlayed(true);
        this.C.setEnableDragViewTouchEvents(true);
        this.C.setPanelSlideListener(this.aa);
        this.W = (ScrollView) view.findViewById(R.id.myScrollView);
        d();
        this.m = (TextView) view.findViewById(R.id.device_firmware_version_text);
        this.n = (TextView) view.findViewById(R.id.device_heartrate_firmware_version_text);
        this.l = (TextView) view.findViewById(R.id.device_set_goal_text);
        this.o = (TextView) view.findViewById(R.id.mili_rebind_tips);
        this.B = (TextView) view.findViewById(R.id.mili_rebind_tips_in_mask);
        this.N = view.findViewById(R.id.device_find_bracelet);
        this.N.setOnClickListener(this);
        this.O = (TextView) view.findViewById(R.id.device_find_bracelet_tv);
        view.findViewById(R.id.device_set_goal).setOnClickListener(this);
        view.findViewById(R.id.device_unbind).setOnClickListener(this);
        View findViewById = view.findViewById(R.id.device_light_color);
        findViewById.setOnClickListener(this);
        View findViewById2 = view.findViewById(R.id.device_wear_hand);
        findViewById2.setOnClickListener(this);
        view.findViewById(R.id.device_weixin_enter_ll).setOnClickListener(this);
        view.findViewById(R.id.device_qq_health).setOnClickListener(this);
        View findViewById3 = view.findViewById(R.id.device_firmware_version);
        findViewById3.setOnClickListener(this);
        View findViewById4 = view.findViewById(R.id.notification_setting);
        findViewById4.setOnClickListener(this);
        View findViewById5 = view.findViewById(R.id.incoming_call_notify);
        findViewById5.setOnClickListener(this);
        View findViewById6 = view.findViewById(R.id.alarm_notify);
        findViewById6.setOnClickListener(this);
        View findViewById7 = view.findViewById(R.id.sms_notify);
        findViewById7.setOnClickListener(this);
        View findViewById8 = view.findViewById(R.id.item_heart);
        if (!this.U) {
            findViewById6.setVisibility(8);
            findViewById7.setVisibility(8);
            view.findViewById(R.id.alarm_notify_split).setVisibility(8);
            view.findViewById(R.id.sms_notify_split).setVisibility(8);
            view.findViewById(R.id.other_tv).setVisibility(8);
            view.findViewById(R.id.other_split).setVisibility(8);
            view.findViewById(R.id.notify_setting_tv).setVisibility(8);
            view.findViewById(R.id.notify_setting_split).setVisibility(8);
        }
        View findViewById9 = view.findViewById(R.id.vibrate_notify);
        findViewById9.setOnClickListener(this);
        View findViewById10 = view.findViewById(R.id.setting_daily_sport_notify);
        findViewById10.setOnClickListener(this);
        view.findViewById(R.id.device_unbind_in_mask).setOnClickListener(this);
        View findViewById11 = view.findViewById(R.id.device_unlock_screen);
        findViewById11.setOnClickListener(this);
        View findViewById12 = view.findViewById(R.id.sleep_assist_contaier);
        findViewById12.setOnClickListener(this);
        if (!C0623s.b(getActivity())) {
            view.findViewById(R.id.device_unlock_split).setVisibility(8);
            findViewById11.setVisibility(8);
        }
        this.V = (TextView) view.findViewById(R.id.device_unlock_screen_text);
        g();
        this.p = (TextView) view.findViewById(R.id.device_battery_percent_text);
        this.y = view.findViewById(R.id.device_battery_percent_mark);
        this.q = (TextView) view.findViewById(R.id.device_battery_day_text);
        this.r = (TextView) view.findViewById(R.id.device_battery_low_text);
        this.z = (ImageView) view.findViewById(R.id.device_battery_center_img);
        this.G = view.findViewById(R.id.device_battery_area);
        if (!this.P.w.booleanValue()) {
            ((TextView) view.findViewById(R.id.device_battery_battery_txt)).setText(a.f);
        }
        this.s = view.findViewById(R.id.mask_view);
        this.t = view.findViewById(R.id.mili_top_bar);
        this.u = (LinePieChartView) view.findViewById(R.id.battery_pie_chart);
        this.u.a(1);
        this.w = (TextView) view.findViewById(R.id.device_light_color_txt);
        this.x = (TextView) view.findViewById(R.id.device_wear_hand_text);
        ...
        this.J = (TextView) view.findViewById(R.id.notification_available);
        this.K = (TextView) view.findViewById(R.id.incoming_call_notify_text);
        this.L = (TextView) view.findViewById(R.id.alarm_notify_text);
        this.M = (TextView) view.findViewById(R.id.sms_notify_text);
        this.F = (Switch) view.findViewById(R.id.vibrate_notify_switch);
        this.F.setChecked(this.k.getMiliVibrate());
        this.F.setOnCheckedChangeListener(new C0787eh(this));
        this.X = (Switch) view.findViewById(R.id.sleep_assist_switch);
        this.X.setChecked(this.k.getMiliSleepAssist());
        this.X.setOnCheckedChangeListener(new C0788ei(this));
        this.Q = (Switch) view.findViewById(R.id.setting_daily_sport_notify_switch);
        ...
        if (this.Y.a != 4) {
            ...
            view.findViewById(R.id.setting_realtime_hr_ll).setVisibility(8);
            view.findViewById(R.id.view_fill).setVisibility(8);
            findViewById12.setVisibility(8);
        }
        if (this.Y.a != 0) {
            findViewById.setVisibility(8);
            view.findViewById(R.id.margin_light_color).setVisibility(8);
        }
        View findViewById13 = view.findViewById(R.id.setting_daily_sleep_notify);
        findViewById13.setOnClickListener(this);
        if (t.a()) {
            this.q.setTextSize(14.0f);
            this.O.setTextSize(13.5f);
            ((TextView) findViewById.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById2.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById11.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById4.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById5.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById9.findViewById(R.id.item_title)).setTextSize(13.5f);
            this.o.setTextSize(13.5f);
            ((TextView) findViewById3.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById8.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById10.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById13.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById7.findViewById(R.id.item_title)).setTextSize(13.5f);
            ((TextView) findViewById12.findViewById(R.id.item_title)).setTextSize(13.5f);
            this.w.setTextSize(11.0f);
            this.x.setTextSize(11.0f);
            this.J.setTextSize(11.0f);
            this.K.setTextSize(11.0f);
            ((TextView) view.findViewById(R.id.vibrate_notify_text)).setTextSize(11.0f);
            ((TextView) view.findViewById(R.id.sleep_assist_info)).setTextSize(11.0f);
            this.m.setTextSize(11.0f);
            this.n.setTextSize(11.0f);
        }
        this.R = (Switch) view.findViewById(R.id.setting_daily_sleep_notify_switch);
        this.R.setChecked(this.k.getMiliConfig().getDailySleepNofity());
        this.R.setOnCheckedChangeListener(new C0791el(this));
        view.findViewById(R.id.setting_realtime_hr_ll).setOnClickListener(this);
        this.S = (Switch) view.findViewById(R.id.setting_realtime_hr_switch);
    ...
    private void a(TextView textView) {
        if (QQLogin.getInstance(getActivity().getApplicationContext()).isLoginValid()) {
            textView.setText(R.string.state_binded);
        } else {
            textView.setText(R.string.state_unbinded);
        }
    }
    ...
    private void b(boolean z) {
        ...
        this.O.setTextColor(getResources().getColor(R.color.disabled_text_color));
    }
            ...
            switch (this.j.d) {
                ...
                case kankan.wheel.widget.a.aQ /*4*/:
                    ...
                    if (this.j.b.get(1) == kankan.wheel.widget.a.bZ) {
                        ...
                        if (i == 0) {
                            this.A = getResources().getString(R.string.first_use_days_today_format);
                        } else {
                            this.A = String.format(getResources().getText(R.string.first_use_remain_days_format).toString(), new Object[]{Integer.valueOf(i)});
                        }
                        if (i == 1) {
                        ...
                        if (i == 0) {
                            this.A = getResources().getString(R.string.remain_days_today_format);
                        } else {
                            this.A = String.format(getResources().getText(R.string.remain_days_format).toString(), new Object[]{Integer.valueOf(i)});
                        }
                        if (i == 1) {
                            this.A = this.A.replace(cn.com.smartdevices.bracelet.j.f.as, "day");
                        }
                ...
                case kankan.wheel.widget.a.k /*2*/:
                    this.u.a(2);
                    this.u.c((long) h);
                    this.q.setText(R.string.battery_charging);
                    this.z.setImageResource(R.drawable.searching_mili_icon);
                ...
                case kankan.wheel.widget.a.l /*3*/:
                    ...
                    this.u.b(a((int) g));
                    this.u.a(1);
                    this.q.setText(R.string.battery_charge_full);
                    this.z.setVisibility(8);
                    this.p.setText("100");
                    this.p.setVisibility(0);
                    this.y.setVisibility(0);
    ...
    private void d() {
        ...
        if (a.d()) {
            ...
            dimensionPixelSize = getResources().getDimensionPixelSize(R.dimen.main_ui_dragview_height);
    ...
    private void g() {
        if (C0623s.a(getActivity())) {
            ...
            this.V.setText(R.string.state_open);
        } else {
            this.V.setText(R.string.state_close);
        }
    }
    ...
    private void h() {
        if (!a(this.D)) {
            ...
            if (i >= 3) {
                this.I = h.d;
                com.huami.android.view.b.a(getActivity(), (int) R.string.find_bracelet_warning, 1).show();
            }
    ...
    private void m() {
        ...
        this.q.setText(R.string.bracelet_not_connected_bat_unknown);
        this.p.setVisibility(4);
        this.y.setVisibility(4);
        this.u.b();
        this.z.setImageResource(R.drawable.wrong_mark);
        this.z.setVisibility(0);
        this.u.a(100);
        this.u.b(100);
        this.u.a(0);
        ...
        if (Utils.e()) {
            ...
            this.B.setText(R.string.bind_new_mili);
        }
    }
    ...
    private void o() {
        if (cn.com.smartdevices.bracelet.notification.h.a(getActivity()).f()) {
            this.J.setText(getString(R.string.state_open));
        } else {
            this.J.setText(getString(R.string.state_close));
        }
    }
    ...
    private void p() {
        ...
        if (!this.U) {
            if (this.k.isInComingCallEnabled()) {
                this.K.setText(getString(R.string.incoming_call_notify_tips, new Object[]{Integer.valueOf(this.k.getInComingCallTime())}));
            } else {
                this.K.setText(getString(R.string.state_close));
            }
            ...
            this.K.setText(getString(R.string.incoming_call_notify_tips, new Object[]{Integer.valueOf(i)}));
        } else {
            this.K.setText(getString(R.string.state_close));
        }
        if (this.U) {
            if (a.b(this.T)) {
                this.L.setText(R.string.state_open);
            } else {
                this.L.setText(R.string.state_close);
            }
            if (a.d(this.T)) {
                this.M.setText(R.string.state_open);
            } else {
                this.M.setText(R.string.state_close);
            }
        }
    }
    ...
    private void q() {
        if (MiliConfig.LEFT_HAND.equals(this.k.getMiliWearHand())) {
            ...
            this.x.setText(R.string.right_hand);
        } else {
            this.x.setText(R.string.body);
        }
    }

    private void r() {
        if (MiliConfig.BLUE.equals(this.k.getMiliColor())) {
            this.w.setText(R.string.blue);
        } else if (MiliConfig.ORANGE.equals(this.k.getMiliColor())) {
            this.w.setText(R.string.orange);
        } else if (MiliConfig.GREEN.equals(this.k.getMiliColor())) {
            this.w.setText(R.string.green);
        } else if (MiliConfig.RED.equals(this.k.getMiliColor())) {
            this.w.setText(R.string.red);
        }
    }

    private void s() {
        this.l.setText(this.k.getDaySportGoalSteps() + getString(R.string.step_per_day));
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.device_set_goal:
                ...
                return;
            case R.id.device_find_bracelet:
                h();
                C0401a.a(getActivity(), C0401a.dK);
                return;
            case R.id.device_light_color:
                c.showPanel(getActivity(), cY.class);
                return;
            case R.id.device_wear_hand:
                c.showPanel(getActivity(), C0762dk.class);
                return;
            case R.id.device_unlock_screen:
                intent = new Intent();
            ...
            case R.id.notification_setting:
                ...
                return;
            case R.id.incoming_call_notify:
                ...
                return;
            case R.id.sleep_assist_contaier:
                this.X.toggle();
                return;
            case R.id.alarm_notify:
                ...
                return;
            case R.id.sms_notify:
                intent = new Intent(getActivity(), SettingPhoneNotifyActivity.class);
                intent.putExtra(SettingPhoneNotifyActivity.a, 2);
                startActivity(intent);
                return;
            case R.id.vibrate_notify:
                this.F.toggle();
                return;
            case R.id.setting_daily_sport_notify:
                this.Q.toggle();
                return;
            case R.id.setting_daily_sleep_notify:
                this.R.toggle();
                return;
            case R.id.setting_realtime_hr_ll:
                this.S.toggle();
                return;
            case R.id.device_qq_health:
                startActivity(new Intent(getActivity(), BindQQHealthActivity.class));
                return;
            case R.id.device_weixin_enter_ll:
            ...
            case R.id.device_firmware_version:
                ...
                com.huami.android.view.b.a(getActivity(), getActivity().getString(R.string.bracelet_info_mac_address, new Object[]{readBraceletBtInfo.c, readBraceletBtInfo.b}), 1).show();
                return;
    ...
    public void onResume() {
        ...
        C0401a.a(C0401a.N);
        View view = (View) getView().findViewById(R.id.device_qq_health).getParent();
        if (this.P.c.d.booleanValue()) {
            a((TextView) getView().findViewById(R.id.bind_qq_heath_state));
        } else {
