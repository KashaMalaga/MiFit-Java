...
public class C0811k extends c {
    ...
    protected int inflateLayout() {
        return R.layout.fragment_babyweight_2small;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.e = (TextView) onCreateView.findViewById(R.id.content);
        this.e.setText(this.h);
        this.f = (DimPanelBottomBar) onCreateView.findViewById(R.id.dimbtmbar);
        this.f.a(this.j);
        this.f.b(this.i);
        return onCreateView;
    }
