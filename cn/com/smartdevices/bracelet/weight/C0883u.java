...
class C0883u implements c {
    ...
    public void a(WheelView wheelView, int i, int i2) {
        if (this.a.isAdded()) {
            this.a.d.a(5).e(R.drawable.wheel_custom_val_white_1).a(this.a.getString(R.string.day_ri), (float) aA.h).a(new C0763dl(this.a.getActivity(), 1, this.a.a(this.a.m, i2 + 1), this.a.d, this.a.getResources().getColor(R.color.highlight), this.a.getResources().getColor(R.color.main_ui_content_color), a.bm, false, 46, 24, 21, 21, 1)).a(true);
