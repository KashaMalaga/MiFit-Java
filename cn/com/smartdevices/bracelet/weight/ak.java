...
class ak extends h {
    ...
    ak(ah ahVar, Context context, SyncResult syncResult, List list) {
        this.d = ahVar;
        this.a = context;
        this.b = syncResult;
        this.c = list;
    ...
    public void onFailure(int i, Header[] headerArr, byte[] bArr, Throwable th) {
        C0596r.d("WeightInfoManager", "Sync Deleted WeightInfos To Server Failure!!");
        if (bArr != null) {
    ...
    public void onSuccess(int i, Header[] headerArr, byte[] bArr) {
        C0596r.d("WeightInfoManager", "Sync Deleted WeightInfos To Server Success!!");
        if (bArr != null) {
