...
class a implements e {
    ...
    public void b(WheelView wheelView) {
        ...
        if (100 == wheelView.f()) {
            ...
            f c0763dl = new C0763dl(this.a, 1, this.a.o + 1, this.a.i, this.a.getResources().getColor(R.color.title_color), this.a.getResources().getColor(R.color.content_color), this.a.getResources().getColor(R.color.content_color_darker), false, 50, 48, 45, 45);
