...
final class l {
    ...
    private synchronized void a() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{m.n, 379}, "FR");
            a(new int[]{380}, "BG");
            a(new int[]{383}, "SI");
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            a(new int[]{400, BaseActivity.MI_NOTE_ORIGINAL_DPI}, "DE");
            a(new int[]{450, 459}, "JP");
            a(new int[]{a.aA, 469}, "RU");
            a(new int[]{471}, "TW");
            a(new int[]{474}, "EE");
            a(new int[]{475}, "LV");
            a(new int[]{476}, "AZ");
            ...
            a(new int[]{a.aB, 509}, "GB");
            a(new int[]{MainUIActivity.c}, "GR");
            a(new int[]{528}, C1009k.b);
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            a(new int[]{535}, "MT");
            a(new int[]{539}, "IE");
            ...
            a(new int[]{594}, "RO");
            a(new int[]{599}, "HU");
            a(new int[]{cn.com.smartdevices.bracelet.chart.util.a.b, 601}, "ZA");
            a(new int[]{603}, "GH");
            a(new int[]{608}, "BH");
            a(new int[]{609}, "MU");
            a(new int[]{611}, "MA");
            ...
            a(new int[]{cn.com.smartdevices.bracelet.chart.util.a.d, 839}, "IT");
