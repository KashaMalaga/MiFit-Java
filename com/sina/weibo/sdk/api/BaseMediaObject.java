...
public abstract class BaseMediaObject implements Parcelable {
    ...
    protected boolean checkArgs() {
        if (this.actionUrl == null || this.actionUrl.length() > C0113o.j) {
            LogUtil.e("Weibo.BaseMediaObject", "checkArgs fail, actionUrl is invalid");
            return false;
        } else if (this.identify == null || this.identify.length() > C0113o.j) {
            LogUtil.e("Weibo.BaseMediaObject", "checkArgs fail, identify is invalid");
            return false;
        } else if (this.thumbData == null || this.thumbData.length > WXMediaMessage.THUMB_LENGTH_LIMIT) {
            ...
            return false;
        } else if (this.title == null || this.title.length() > C0113o.j) {
            LogUtil.e("Weibo.BaseMediaObject", "checkArgs fail, title is invalid");
            return false;
        } else if (this.description != null && this.description.length() <= b.a) {
            return true;
        } else {
