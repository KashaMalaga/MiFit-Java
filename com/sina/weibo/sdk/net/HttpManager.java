...
class HttpManager {
    ...
    public static synchronized String downloadFile(Context context, String str, String str2, String str3) {
        String path;
        synchronized (HttpManager.class) {
            ...
            if (file2.exists()) {
                ...
                try {
                    ...
                    InputStream content = (firstHeader2 == null || firstHeader2.getValue().toLowerCase().indexOf(C1012a.g) <= -1) ? entity.getContent() : new GZIPInputStream(entity.getContent());
    ...
    public static String openUrl(Context context, String str, String str2, WeiboParameters weiboParameters) {
        String readRsponse = readRsponse(requestHttpExecute(context, str, str2, weiboParameters));
        LogUtil.d(TAG, "Response : " + readRsponse);
        return readRsponse;
    }

    public static String openUrl4RdirectURL(Context context, String str, String str2, WeiboParameters weiboParameters) {
        Throwable th;
        Throwable th2;
        HttpClient httpClient = null;
        String str3 = a.f;
        try {
            ...
            try {
                ...
                if (statusCode == 301 || statusCode == 302) {
                    value = execute.getFirstHeader(e.e).getValue();
        ...
        if (httpResponse != null) {
            ...
            try {
                ...
                try {
                    ...
                    if (firstHeader != null && firstHeader.getValue().toLowerCase().indexOf(C1012a.g) > -1) {
                    ...
                    str = new String(byteArrayOutputStream.toByteArray(), h.DEFAULT_CHARSET);
                ...
                if (str2.equals(HTTP_METHOD_GET)) {
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            ...
                            byteArrayOutputStream2.write(encodeUrl.getBytes(h.DEFAULT_CHARSET));
                        }
                    ...
                    httpGet = str2.equals("DELETE") ? new HttpDelete(str) : null;
                }
    ...
    private static void setHttpCommonParam(Context context, WeiboParameters weiboParameters) {
        ...
        if (!TextUtils.isEmpty(weiboParameters.getAppKey())) {
            ...
            if (!TextUtils.isEmpty(str)) {
                weiboParameters.put(WBConstants.AUTH_PARAMS_AID, str);
            }
        }
        String str2 = str;
        ...
        String str3 = a.f;
        Object obj = weiboParameters.get(com.xiaomi.account.openauth.h.I);
        Object obj2 = weiboParameters.get(f.aX);
        str = (obj == null || !(obj instanceof String)) ? (obj2 == null || !(obj2 instanceof String)) ? str3 : (String) obj2 : (String) obj;
