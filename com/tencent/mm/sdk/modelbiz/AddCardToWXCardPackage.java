    ...
    public class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            ...
            for (WXCardItem wXCardItem : this.cardArrary) {
                if (wXCardItem == null || wXCardItem.cardId == null || wXCardItem.cardId.length() > b.a || (wXCardItem.cardExtMsg != null && wXCardItem.cardExtMsg.length() > b.a)) {
                    return false;
                }
            }
            return true;
        ...
        public void toBundle(Bundle bundle) {
            ...
            try {
                ...
                for (WXCardItem wXCardItem : this.cardArrary) {
                    ...
                    jSONStringer.value(wXCardItem.cardExtMsg == null ? a.f : wXCardItem.cardExtMsg);
