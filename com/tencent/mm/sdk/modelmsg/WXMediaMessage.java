...
public final class WXMediaMessage {
    ...
    final boolean checkArgs() {
        if (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) {
            ...
            return false;
        } else if (this.mediaTagName != null && this.mediaTagName.length() > MEDIA_TAG_NAME_LENGTH_LIMIT) {
            a.a(TAG, "checkArgs fail, mediaTagName is too long");
            return false;
        } else if (this.messageAction != null && this.messageAction.length() > MESSAGE_EXT_LENGTH_LIMIT) {
            a.a(TAG, "checkArgs fail, messageAction is too long");
            return false;
        } else if (this.messageExt == null || this.messageExt.length() <= MESSAGE_EXT_LENGTH_LIMIT) {
