...
public class SocialApiIml extends BaseApi {
    ...
    class a implements IUiListener {
        ...
        public void onError(UiError uiError) {
            f.b("openSDK_LOG", "OpenApi, EncryptTokenListener() onError" + uiError.errorMessage);
    ...
    private void a(Activity activity, String str, Bundle bundle, String str2, IUiListener iUiListener) {
        ...
        targetActivityIntent2.putExtra(h.I, this.mToken.getAccessToken());
    ...
    public void writeEncryToken(Context context) {
        ...
        bVar.loadDataWithBaseURL(str, accessToken, "text/html", kankan.wheel.widget.a.bO, str);
    }
}
