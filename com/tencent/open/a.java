...
public class a {
    ...
    public void a(String str, String str2, List<String> list, a aVar) {
        f.b("openSDK_LOG.JsBridge", "getResult---objName = " + str + " methodName = " + str2);
        int size = list.size();
        for (int i = 0; i < size; i++) {
            try {
                list.set(i, URLDecoder.decode((String) list.get(i), h.DEFAULT_CHARSET));
    ...
    public boolean a(WebView webView, String str) {
        f.b("openSDK_LOG.JsBridge", "-->canHandleUrl---url = " + str);
