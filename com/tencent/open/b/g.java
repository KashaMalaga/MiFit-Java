...
public class g {
                ...
                this.g.execute(new Runnable(this) {
                    ...
                    public void run() {
                        try {
                            ...
                            bundle.putString(o.z, c.b(Global.getContext()));
                            bundle.putString("imsi", c.c(Global.getContext()));
                            bundle.putString("android_id", c.d(Global.getContext()));
                            bundle.putString(cn.com.smartdevices.bracelet.shoes.sync.b.g.q, c.a());
                            ...
                            bundle.putString(LocationManagerProxy.NETWORK_PROVIDER, a.a(Global.getContext()));
                            bundle.putString("language", c.b());
                            bundle.putString(o.p, c.a(Global.getContext()));
                            bundle.putString("apn", a.b(Global.getContext()));
                            bundle.putString("model_name", Build.MODEL);
                            bundle.putString(cn.com.smartdevices.bracelet.j.f.j, TimeZone.getDefault().getID());
            ...
            this.h.execute(new Runnable(this) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        bundle.putString(cn.com.smartdevices.bracelet.j.f.au, str4);
                        ...
                        bundle.putString("frequency", i + a.f);
                        bundle.putString("reqSize", j5 + a.f);
                        bundle.putString("resultCode", i2 + a.f);
                        bundle.putString("rspSize", j6 + a.f);
                        bundle.putString("timeCost", elapsedRealtime + a.f);
                        bundle.putString("uin", Constants.DEFAULT_UIN);
                        ...
                        if (this.h.a("report_cgi", size) || z2) {
                            this.h.b();
                            this.h.f.removeMessages(h.E);
                        } else if (!this.h.f.hasMessages(h.E)) {
                            Message obtain = Message.obtain();
                            obtain.what = h.E;
    ...
    public void a(String str, String str2, Bundle bundle, boolean z) {
        ...
        ThreadManager.executeOnSubThread(new Runnable(this) {
            ...
            public void run() {
                ...
                httpGet.addHeader(C1012a.f, C1012a.g);
                ...
                if (c != null) {
                    ...
                    do {
                        ...
                        try {
                            ...
                            try {
                                f.a("openSDK_LOG.ReportManager", "-->doReportCgi, doupload exception", e);
                                continue;
                            } catch (Throwable e2) {
                                f.a("openSDK_LOG.ReportManager", "-->doReportCgi, doupload exception out.", e2);
                                return;
                            }
                        } catch (Throwable e3) {
                            f.a("openSDK_LOG.ReportManager", "-->doReportCgi, doupload exception", e3);
                            continue;
                        } catch (Throwable e22) {
                            f.a("openSDK_LOG.ReportManager", "-->doReportCgi, doupload exception", e22);
                        }
                        if (obj == null) {
    ...
    protected Bundle c() {
        ...
        try {
            ...
            bundle.putString(cn.com.smartdevices.bracelet.shoes.sync.b.g.r, Build.DEVICE);
            bundle.putString("qua", Constants.SDK_QUA);
            bundle.putString(C0430g.b, "apn,frequency,commandid,resultcode,tmcost,reqsize,rspsize,detail,touin,deviceinfo");
            for (int i = 0; i < this.c.size(); i++) {
                ...
                bundle.putString(i + "_8", (String) bVar.a.get(cn.com.smartdevices.bracelet.j.f.au));
    ...
    protected Bundle d() {
        ...
        try {
            jSONObject2.put(b.b, jSONArray);
            bundle.putString(b.b, jSONObject2.toString());
            return bundle;
        } catch (Throwable e2) {
