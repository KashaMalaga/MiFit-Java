...
public class OpenConfig {
    ...
    private void a(String str, String str2) {
        try {
            ...
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(this.c.openFileOutput(str, 0), Charset.forName(h.DEFAULT_CHARSET));
    ...
    public static OpenConfig getInstance(Context context, String str) {
        ...
        if (str == null) {
            str = b != null ? b : Constants.VIA_RESULT_SUCCESS;
        }
