...
final class e {
    ...
    final void a(JSONObject jSONObject, Thread thread) {
        if (thread == null) {
            ...
            r.a(jSONObject, m.c, c.f(this.cB));
            ...
            if (l.e(this.cF) && this.cF.split("/").length == 2) {
                r.a(jSONObject, QQLogin.KEY_FROM, this.cF.split("/")[0]);
            }
            if (t.s(this.cB).t(this.cB) != null) {
                jSONObject.put("ui", t.s(this.cB).t(this.cB).b());
            }
            r.a(jSONObject, "mid", c.h(this.cB));
        }
