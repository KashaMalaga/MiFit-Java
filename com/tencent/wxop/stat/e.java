...
public class e {
    ...
    private static volatile String aR = a.f;
    private static volatile String aS = a.f;
    ...
    private static JSONObject G() {
        ...
        try {
            ...
            if (c.P.L != 0) {
                jSONObject2.put(SportBaseInfo.VERSION, c.P.L);
            }
            jSONObject.put(Integer.toString(c.P.aI), jSONObject2);
            jSONObject2 = new JSONObject();
            if (c.O.L != 0) {
                jSONObject2.put(SportBaseInfo.VERSION, c.O.L);
            }
