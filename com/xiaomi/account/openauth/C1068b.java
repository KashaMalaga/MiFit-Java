...
public class C1068b {
    ...
    private static final String e = "open.account.xiaomi.com";
    private static final String f = "https://open.account.xiaomi.com";

    @Deprecated
    public static String a(Context context, String str, long j, String str2) {
        return C1068b.a(str, j, str2, null, null);
    }

    @Deprecated
    public static String a(Context context, String str, long j, String str2, String str3, String str4) {
        return C1068b.a(str, j, str2, str3, str4);
    }
    ...
    public static java.lang.String a(java.lang.String r7, long r8, java.lang.String r10, java.lang.String r11, java.lang.String r12) {
        /*
        ...
        r2 = r2.append(r4);	 Catch:{ UnsupportedEncodingException -> 0x007b, IOException -> 0x009d, NoSuchAlgorithmException -> 0x00d1, InvalidKeyException -> 0x00d8 }
        ...
        r2 = com.xiaomi.account.openauth.c.a(r2, r1);	 Catch:{ UnsupportedEncodingException -> 0x007b, IOException -> 0x009d, NoSuchAlgorithmException -> 0x00d1, InvalidKeyException -> 0x00d8 }
        ...
        r4 = com.xiaomi.account.openauth.C1068b.a(r7, r10, r11, r12, r1);	 Catch:{ UnsupportedEncodingException -> 0x007b, IOException -> 0x009d, NoSuchAlgorithmException -> 0x00d1, InvalidKeyException -> 0x00d8 }
    ...
    L_0x007b:
        ...
        r1 = r3;
    L_0x007d:
        r2 = new com.xiaomi.account.openauth.g;	 Catch:{ all -> 0x0083 }
    ...
    L_0x0083:
        ...
        r3 = r1;
    L_0x0085:
        com.xiaomi.account.openauth.C1068b.a(r3);
        throw r0;
    L_0x0089:
    ...
    L_0x0092:
        r0 = new com.xiaomi.account.openauth.g;	 Catch:{ UnsupportedEncodingException -> 0x007b, IOException -> 0x009d, NoSuchAlgorithmException -> 0x00d1, InvalidKeyException -> 0x00d8 }
    ...
    L_0x009d:
        r0 = move-exception;
    L_0x009e:
        r1 = new com.xiaomi.account.openauth.g;	 Catch:{ all -> 0x00a4 }
    ...
    L_0x00c9:
        ...
        com.xiaomi.account.openauth.C1068b.a(r1);
        return r0;
    L_0x00d1:
        r0 = move-exception;
    L_0x00d2:
    ...
    L_0x00e5:
        ...
        goto L_0x009e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.account.openauth.b.a(java.lang.String, long, java.lang.String, java.lang.String, java.lang.String):java.lang.String");
    }

    private static HashMap<String, String> a(String str, String str2, String str3, String str4, List<NameValuePair> list) {
        if (str3 == null && str4 == null) {
            return null;
        }
        String a = c.a();
        return c.a(str2, a, c.a(a, d, e, str, URLEncodedUtils.format(list, c), str3, str4));
    }
