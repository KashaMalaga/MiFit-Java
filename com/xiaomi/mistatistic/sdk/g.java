...
class g extends WebViewClient {
    ...
    public g(MIWebView mIWebView, WebViewClient webViewClient) {
        this.a = mIWebView;
    ...
    public void onPageFinished(WebView webView, String str) {
        ...
        if (l != null) {
            u.a().a(new a(str, System.currentTimeMillis() - l.longValue()));
        }
    }
    ...
    public void onReceivedError(WebView webView, int i, String str, String str2) {
        ...
        if (l != null) {
            u.a().a(new a(str2, System.currentTimeMillis() - l.longValue(), (long) i));
        }
    }
