...
public class ErrorDialogManager {
    ...
    public class SupportManagerFragment extends android.support.v4.app.Fragment {
        ...
        public static void attachTo(Activity activity, Object obj, boolean z, Bundle bundle) {
            R i = ((FragmentActivity) activity).i();
            SupportManagerFragment supportManagerFragment = (SupportManagerFragment) i.a(ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER);
            if (supportManagerFragment == null) {
                supportManagerFragment = new SupportManagerFragment();
                i.a().a((android.support.v4.app.Fragment) supportManagerFragment, ErrorDialogManager.TAG_ERROR_DIALOG_MANAGER).h();
                i.c();
            }
        ...
        public void onEventMainThread(ThrowableFailureEvent throwableFailureEvent) {
            if (ErrorDialogManager.isInExecutionScope(this.executionScope, throwableFailureEvent)) {
                ...
                fragmentManager.c();
                I i = (I) fragmentManager.a(ErrorDialogManager.TAG_ERROR_DIALOG);
                if (i != null) {
                    i.dismiss();
                }
                i = (I) ErrorDialogManager.factory.prepareErrorFragment(throwableFailureEvent, this.finishAfterDialog, this.argumentsForErrorDialog);
                if (i != null) {
                    i.show(fragmentManager, ErrorDialogManager.TAG_ERROR_DIALOG);
                }
            }
        }
