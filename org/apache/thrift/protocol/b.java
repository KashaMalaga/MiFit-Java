...
public final class b extends f {
    private static final k d = new k(com.xiaomi.e.a.f);
    private static final c f = new c(com.xiaomi.e.a.f, (byte) 0, (short) 0);
    ...
    public c i() {
        ...
        short s = (short) ((r & RunningReminderInfo.b) >> 4);
        c cVar = new c(com.xiaomi.e.a.f, d((byte) (r & 15)), s == (short) 0 ? s() : (short) (s + this.i));
        if (c(r)) {
    ...
    public String w() {
        ...
        try {
            if (this.e.c() < z) {
                return new String(e(z), com.d.a.a.h.DEFAULT_CHARSET);
            }
            String str = new String(this.e.a(), this.e.b(), z, com.d.a.a.h.DEFAULT_CHARSET);
            this.e.a(z);
            return str;
        } catch (UnsupportedEncodingException e) {
            throw new f("UTF-8 not supported!");
